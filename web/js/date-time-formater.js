...
document.querySelectorAll(".datetime-format").forEach(datetimeformat => {
    ...
    if(datetimeformat.classList.contains('f2')) datetimeformat.innerHTML = formater.getHours()+ ' giờ '+formater.getUTCMinutes() +' phút, Ngày' + formater.getDate() + ', ' + month_name[formater.getMonth()]; 
    else{
