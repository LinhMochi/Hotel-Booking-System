    ...
    <body>
        <div class="reset-box box 1">
            ...
            <form action="">
                ...
                <button type="button" class="submit">Gửi mã OTP</button>
            </form>
        </div>
        ...
        //		document.querySelector('.preloading').classList.toggle('active');   
                ...
                if (i === 2) {
                    if (!confirmpassword())
                        ...
                        sendRequest('forgotpassword', 'req=reset&password=' + document.querySelector('#password').value, newpass);
                }
            }
        ...
        //
            ...
            function getMessage(message) {
                ...
                error_box.querySelectorAll('.error-message').forEach(err => {
                    if (err.offsetWidth == 0)
                        err.classList.add('absolutely');
                });
