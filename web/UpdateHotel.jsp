<%-- 
    ...
    Created on : Jun 28, 2022, 9:01:10 AM
    Author     : Nhat Anh
--%>
...
<html>
    ...
    <body>
        <h1>${hotel.name}</h1>
        <form method="post" action="UpdateHotels">
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    <tr>
                        <th>ID</th>
                        <td><input  style="width: 700px; height: 50px" type="text" disabled name="id" value="${hotel.id}"></td>

                    </tr>
                    <tr>
                        <th>Name</th>
                        <td><input  style="width: 700px; height: 50px" type="text" name="name" value="${hotel.name}"></td>

                    </tr>

                    <tr>
                        <th>NoOfStar</th>>
                        <td><input style="width: 700px; height: 50px" type="text" name="star" value="${hotel.star}"></td>
