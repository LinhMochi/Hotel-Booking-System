...
<html>
    ...
    <body class="layout-1-1-2">
        <header class="header nav-top layout-1-2">
        ...
        <div class="search-wrapper layout-2-2">
        ...
        <div class="aside-left">
            ...
            <div class="filter-box">
                ...
                <li><input type="checkbox" name="c">Nhà hàng</li>
                <li><input type="checkbox" name="c">Khu vui chơi</li>
                <li><input type="checkbox" name="c">Giải trí</li>
                <li><input type="checkbox" name="c">Công viên</li>
                <li><input type="checkbox" name="c">Bãi biển</li>
            </div>
        </div>

        <div class="container-right">
            <h4>Kết quả tìm kiếm (5)</h4>
            <div class="sort-box">
                <h5>Sắp xếp</h5>
