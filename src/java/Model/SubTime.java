...
public class SubTime {
    ...
    public String getUnit(int i){
        switch(i){
            case 0: return " năm trước.";
            case 1: return " tháng trước.";
            case 2: return " ngày trước.";
            case 3: return " giờ trước.";
            case 4: return " phút trước.";
            case 5: return " giây trước.";
        }
